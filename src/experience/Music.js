...
export default class Music {
    ...
    #setupIllustrations() {
        this.listeningPlane = this.#setupHtmlArea();
        this.singingPlane = this.#setupHtmlArea();
        this.composingPlane = this.#setupHtmlArea();
        this.modelView.add(this.lottiePlane, this.singingPlane, this.composingPlane);
    }
